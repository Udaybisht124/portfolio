        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 py-8 md:py-16">
            ...
            <div className="relative flex justify-center mb-8 md:mb-0">
                <img
                    ...
                    src="/images/udayimg.jpg"
                    alt="image1"
                />
            </div>

            {/* Text Section */}
            <div className="text-center md:text-right space-y-8 flex flex-col justify-center">
                ...
                <a
                    ...
                    href="\public\udaybishtresume.pdf"
                    download="Uday_Singh_Bisht_Resume.pdf"
                >
                    &nbsp; Download Resume
                </a>
            </div>
